...
const CASES = [
  { img: c1, tag: "Healthcare", title: "Telehealth platform for a national provider network", stats: ["+62%", "-38%"], statLabels: ["Patient throughput", "Waiting time"] },
  { img: c2, tag: "Fintech", title: "Digital-wallet re-platforming for a top-3 telco", stats: ["10M+", "99.99%"], statLabels: ["MAU migrated", "Uptime SLA"] },
  { img: c3, tag: "Retail", title: "Headless commerce for an omnichannel apparel brand", stats: ["+41%", "3.2×"], statLabels: ["Conversion", "Time-to-market"] },
];
          ...
          {CASES.map((c) => (
            ...
            >
              <div className="aspect-[16/10] overflow-hidden bg-muted">
                <img src={c.img.url} alt={c.title} className="h-full w-full object-cover" />
              </div>
              <div className="p-6">
